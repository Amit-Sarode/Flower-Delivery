        ...
        <>
            ...
            <div className='h-[205vh] border border-gray-950'>
                ...
                <div className='page6 w-[50%] float-right  font-gilroy'>
                    <div className='p-20 border border-gray-950'>
                        <h2 className=' text-3xl font-[400] '>Stylish bouquets by florists</h2>
                        <p className=''>At our floral studio, our professional florists craft the most elegant and stylish bouquets using only the freshest and highest quality materials available. We stay up-to-date with the latest floral design trends and offer unique arrangements that are sure to impress. Let us brighten up your day with our stunning bouquets and same-day delivery service.</p>
                    </div>
                    <div className='p-20 border border-gray-950'>
                        <h2 className=' text-3xl font-[400] '>On-time delivery</h2>
                    ...
                    <div className='p-20 border border-gray-950'>
                        ...
                        <p className='leading-4'>You can feel secure when placing an order with us, as we use industry-standard security measures to protect your payment information. Your transaction will be safe and hassle-free, so you can shop with confidence.</p>
                    </div>
                    <div className='p-[69px] border border-gray-950'>
                        <h2 className=' text-3xl font-[400] '>Subscription by your needs</h2>
                        <p>
